...
from src.visualize import (plot_complexity_curves, plot_best_models, 
                           plot_feature_importance, plot_actual_vs_predicted,
                           plot_attendance_over_time, plot_overfitting_gap)
...
plot_attendance_over_time(matches)
plot_overfitting_gap(best)